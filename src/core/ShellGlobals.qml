// ShellGlobals.qml - Shell-wide globals singleton
//
// Provides shared colors, animations, and utility functions for the shell.
// Based on outfoxxed's quickshell config.
...
Singleton {
    readonly property string rtpath: Quickshell.runtimePath
