...
void ioSetDestroy(pa_io_event* ev, pa_io_event_destroy_cb_t cb) { ev->destroyCb = cb; }
...
void timeSetDestroy(pa_time_event* ev, pa_time_event_destroy_cb_t cb) { ev->destroyCb = cb; }
...
void deferSetDestroy(pa_defer_event* ev, pa_defer_event_destroy_cb_t cb) { ev->destroyCb = cb; }
